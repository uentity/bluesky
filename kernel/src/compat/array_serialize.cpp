...
BS_ARRAY_EXPORT(std::intmax_t, vector_traits)
BS_ARRAY_EXPORT(std::uintmax_t, vector_traits)
...
BS_ARRAY_EXPORT(std::intmax_t, bs_vector_shared)
BS_ARRAY_EXPORT(std::uintmax_t, bs_vector_shared)
...
BS_ARRAY_EXPORT(std::intmax_t      , bs_nparray_traits)
BS_ARRAY_EXPORT(std::uintmax_t     , bs_nparray_traits)
