...
BS_REGISTER_TYPE_T(bs_array, (int, vector_traits));
BS_REGISTER_TYPE_T(bs_array, (unsigned int, vector_traits));
BS_REGISTER_TYPE_T(bs_array, (long, vector_traits));
BS_REGISTER_TYPE_T(bs_array, (long long, vector_traits));
BS_REGISTER_TYPE_T(bs_array, (unsigned long, vector_traits));
BS_REGISTER_TYPE_T(bs_array, (unsigned long long, vector_traits));
BS_REGISTER_TYPE_T(bs_array, (float, vector_traits));
BS_REGISTER_TYPE_T(bs_array, (double, vector_traits));
BS_REGISTER_TYPE_T(bs_array, (std::string, vector_traits));
BS_REGISTER_TYPE_T(bs_array, (std::wstring, vector_traits));
