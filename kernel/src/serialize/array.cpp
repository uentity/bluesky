...
BSS_EXPORT_ARRAY(std::intmax_t      , vector_traits)
BSS_EXPORT_ARRAY(std::uintmax_t     , vector_traits)
...
BSS_EXPORT_ARRAY(std::intmax_t      , bs_vector_shared)
BSS_EXPORT_ARRAY(std::uintmax_t     , bs_vector_shared)
...
BSS_EXPORT_ARRAY(std::intmax_t      , bs_nparray_traits)
BSS_EXPORT_ARRAY(std::uintmax_t     , bs_nparray_traits)
