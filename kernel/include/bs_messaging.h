...
//class BS_API bs_slot: public combase
//{
//	friend class bs_signal;
//
//public:
//	typedef smart_ptr< bs_slot, true > sp_slot;
//
//	/*!
//	\brief Place your handler code here
...
//
//	struct slot_wrapper;
//	void init(const sp_mobj& sender, int signal_code, const sp_obj& param);
//
//	//destruction method
...
public:
	...
	bool connect(const sp_slot& slot, const sp_mobj& sender) const;
	bool disconnect(const sp_slot& slot) const;
	ulong num_slots() const;

	//call slots, connected to this signal
	void fire(const sp_mobj& sender, const sp_obj& param) const;
