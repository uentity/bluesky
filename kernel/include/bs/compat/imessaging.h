...
public:
	...
	virtual bool subscribe(int signal_code, std::shared_ptr< bs_slot > slot) const = 0;
	virtual bool unsubscribe(int signal_code, std::shared_ptr< bs_slot > slot) const = 0;
	virtual ulong num_slots(int signal_code) const = 0;
	virtual bool fire_signal(int signal_code, std::any param = {}, std::any sender = {}) const = 0;
