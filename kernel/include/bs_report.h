...
/// @author uentity
/// @date 12.01.2016
/// @brief BlueSky logging classes declarations
/// @copyright
...
struct BS_API locked_channel {
	...
	std::string bs_end (std::string msg) const;
...
public:
	...
	locked_channel get_locked (const std::string &name_, const char *file, int line) const {
